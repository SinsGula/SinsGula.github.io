...
var app = {
	counter: -1,
	copy: [
		'Привет... вот и подарок',
		'он исчезнет уже через пару часов поэтому прости.',
		'Такую глупость делаем и постоянно чувство будто я персонаж розыгрыша',
		'Мы об этом говорили, и поэтому хочу облегчить тебе жизнь',
		'что может быть круче любви?',
		'Ничего...',
		'Только когда это на столько что ты можешь показать, ведь так?=)',
		'Самое интерессное, думаю да самое интерессное...',
		'Это то что я влюбился в тебя',
		'И это не весь подарок конечно же',
		'Хотел бы я что бы это было вечно, и ближе как в первые дни общения)))',
		'Ты крутая, милая и красивая)) Да ты это знаешь так что вот... Знаешь, ты чудо...'
	]
};
