...
var app = {
	...
	copy: [
		...
		'Может познакомимся? Меня Гула зовут :)',
		'Почему ты вообще здесь находишься?',
		'Хм, может ты ищешь способ связаться со мной?',
		'Изредко бывает что меня можно найти в ВК. <a href="http://clc.am/KMgduA" target="_blank">Жми сюда, чтобы написать мне</a>. Ну а если я не прав - нажми кнопку еще раз.',
		'Когда тебе уже надоест это делать?',
		'Ты все еще тут??',
		'Мне больше нечего тебе предложить. Еще один клик - и это все прекратится.(но это не точно)'
	]
};
