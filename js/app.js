...
var app = {
	...
	copy: [
		...
		'Привет ! Меня зовут Мася :) да да именно так ты называешь своего парня (он так назвал меня >_<)',
		'Так вот, роза - надеюсь она понравилась тебе :) я выбрал самую красивую :) Уже хочешь открыть коробку? Ответь Масе))) Не мне -.-',
		'Открывай :)))) на самом деле он давно хотел тебе подарить его но не было денег, для этого он ждал пока привезут его (это было дешевле) но ты заболела и он решил обрадовать тебя :) поэтому решил пойти и заработать сыграв в CSGO матч... вот-так вот... надеюсь тебе понравился мишка))) он за ним ехал в другой конец города :)',
		'Он правда пытается всегда удивить тебя (и сейчас он купил его не из за твоих сохранённок) нажми ещё раз на свет:)',
		'Ещё надеюсь тебе понравился доннер, он вкусный :P',
		'Я тебя люблю ♥',
	]
};
